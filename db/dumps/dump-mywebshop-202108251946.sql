...
INSERT INTO `shop` VALUES (1,24,'08:00:00','17:00:00',NULL,NULL,NULL);
...
INSERT INTO `user` VALUES (1,'themhz@gmail.com','526996','themis theotokatos',NULL,'6987556486','dodekanisou 18','ilioupolh','16754',NULL);
...
--
-- Table structure for table `vatlocatons`
--

DROP TABLE IF EXISTS `vatlocatons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vatlocatons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2021-08-25 19:46:31
