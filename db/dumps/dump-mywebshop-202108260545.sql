...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `user_orders` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders_detail` (
  ...
  PRIMARY KEY (`id`),
  KEY `orders_ordersdetail` (`order_id`),
  KEY `product_orderdetail` (`product_id`),
  CONSTRAINT `orders_ordersdetail` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2021-08-26  5:45:12
